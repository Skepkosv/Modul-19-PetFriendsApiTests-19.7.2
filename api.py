...
class PetFriends:
    ...
    def post_api_pets_set_photo(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет (постит) на сервер данные о добавляемом питомце и фото питомца и возвращает статус
    ...
    def put_api_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет запрос на сервер об обновлении данных о питомце по указанному ID и
